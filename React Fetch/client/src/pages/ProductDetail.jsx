...
export default function ProductDetail() {
  ...
  // 4) HOOKS SIEMPRE ANTES DE CUALQUIER RETURN
  ...
  // 5) Recién ahora retornos condicionales
            ...
            {p.reviews && p.reviews.length > 0 ? (
              <>
                {(() => {
                  ...
                  const avg = p.reviews.reduce((sum, r) => sum + r.rating, 0) / total;
